<nav class="navbar navbar-expand-lg navbar-light bg-first fixed-top">
    <a class="navbar-brand" href="/"><img class="logo ml-3" src="media/logo-rocket.png" alt="" /></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
            ...
            @endguest
            <li class="nav-item"><a href="{{ route('announcement.create') }}" class="nav-link btn btn-primary border-0 bg-accent font-weight-bold"><i
                class="fas fa-plus pr-2"></i>Nuovo
                    Annuncio</a> </li>            
        </ul>
