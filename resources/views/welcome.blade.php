<x-layout>
    ...
    <div class="container my-5 py-5">
        <div class="row text-center">
            <div class="col-12">
                <h2 class="h1 text-first font-weight-bold">Gli annunci più recenti</h2>
            </div>
        </div>
        <div class="row">
    ...
    <div class="container">
        <div class="row my-5 py-5 align-items-center">
            <div class="col-12 bg-first bg_light px-3 py-4 d-flex rounded shadow align-items-center flex-wrap">
                <div class="col-12 col-md-8">
                    <h3 class="text-center text-second">Vuoi diventare un revisore di annunci?</h3>
                </div>
                <div class="col-12 col-md-4">
                    <a href="{{ route('contacts') }}" class="nav-link btn btn-primary border-0 bg-accent font-weight-bold">Clicca Qui!</a>
                </div> 
            </div>
        </div>
    </div>
